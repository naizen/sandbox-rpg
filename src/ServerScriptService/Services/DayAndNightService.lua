...
-- time changer
local TIME_SHIFT = .01 -- how many minutes you shift every "tick"
local WAIT_TIME = 1 / 15 -- legnth of the tick
...
local DayAndNightService = Knit.CreateService {
    Name = "DayAndNightService",
    Client = {},
    mam = nil,
    ambience = nil,
    colorShift = nil,
...
function DayAndNightService:KnitInit()
end

function DayAndNightService:KnitStart()
    while true do
        -- time changer
