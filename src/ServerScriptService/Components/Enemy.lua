...
function Enemy:PlayAnim(animName, freezeMarker)
    ...
    -- Freeze the animation at a specified marker
...
function Enemy:Attack()
    if not self.attackDebounce and tick() - self.lastAttackTime > ATTACK_INTERVAL then
        ...
        Debris:AddItem(hitbox, ATTACK_INTERVAL)
...
function Enemy:Start()
    ...
    self.Instance.DamagedEvent.Event:Connect(function(player)
        self:SetTarget(player)
    end)
end
